...
function studentSignupOverlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'student-signup' ),
    overlay = document.querySelector( 'div#student-signup' ),
...
function superSignupOverlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'super-signup' ),
    overlay = document.querySelector( 'div#super-signup' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
...
// Doug --- This is some sort of php form validation. It was being called whenever forms were submitted
